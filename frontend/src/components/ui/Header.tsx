  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-primary/10 dark:border-[#253326] px-6 py-4 lg:px-20 bg-white dark:bg-[#1a251b] transition-colors duration-200">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link href="/apresentacao" className="text-slate-600 dark:text-slate-300 flex items-center gap-1 px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-100 dark:hover:bg-[#152016] transition-colors">
